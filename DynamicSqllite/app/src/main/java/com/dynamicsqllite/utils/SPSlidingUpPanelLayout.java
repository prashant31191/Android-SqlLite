...
public class SPSlidingUpPanelLayout extends ViewGroup {

    private static final String TAG = SPSlidingUpPanelLayout.class.getSimpleName();
    ...
    private SPScrollableViewHelper mScrollableViewHelper = new SPScrollableViewHelper();
    ...
    private final SPViewDragHelper mDragHelper;
    ...
    public SPSlidingUpPanelLayout(Context context) {
        this(context, null);
    }

    public SPSlidingUpPanelLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SPSlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.sp_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.sp_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
        ...
        mDragHelper = SPViewDragHelper.create(this, 0.5f, scrollerInterpolator, new DragHelperCallback());
    ...
    /**
     * Sets the current scrollable view helper. See SPScrollableViewHelper description for details.
     * @param helper
     */
    public void setScrollableViewHelper(SPScrollableViewHelper helper) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mIsScrollableViewHandlingTouch) {
                mDragHelper.setDragState(SPViewDragHelper.STATE_IDLE);
            }
        }
    ...
    private class DragHelperCallback extends SPViewDragHelper.Callback {
        ...
        public void onViewDragStateChanged(int state) {
            if (mDragHelper.getViewDragState() == SPViewDragHelper.STATE_IDLE) {
