package com.dynamicsqllite.database;
...
public class PostsDatabaseHelper  extends SQLiteOpenHelper {
    ...
    String TAG = PostsDatabaseHelper.class.getName();
    ...
    public void addPost(Post post) {
        ...
        try {
            ...
            App.showLog(TAG, "Error while trying to add post to database");
        } finally {
            db.endTransaction();
        }
    }
    ...
    public long addOrUpdateUser(User user) {
        ...
        try {
            ...
            App.showLog(TAG, "Error while trying to add or update user");
        } finally {
            db.endTransaction();
        }
        return userId;
    ...
    public List<Post> getAllPosts() {
        ...
        try {
            ...
            App.showLog(TAG, "Error while trying to get posts from database");
        } finally {
            if (cursor != null && !cursor.isClosed()) {
                cursor.close();
            }
    ...
    public void deleteAllPostsAndUsers() {
        ...
        try {
            ...
            App.showLog(TAG, "Error while trying to delete all posts and users");
        } finally {
            db.endTransaction();
        }
    }
