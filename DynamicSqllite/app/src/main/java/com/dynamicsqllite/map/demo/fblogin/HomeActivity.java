package com.dynamicsqllite.map.demo.fblogin;
...
public class HomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fb_activity_home);
    ...
    private void onSelectFromGalleryResult(Intent data) {
        ...
        //ShareDialogUri(selectedImageUri);
    }
    ...
    public void ShareDialogUri(Uri imagePath){
    ...
    public void setNavigationHeader(){
        ...
        View header = LayoutInflater.from(this).inflate(R.layout.fb_nav_header_home, null);
