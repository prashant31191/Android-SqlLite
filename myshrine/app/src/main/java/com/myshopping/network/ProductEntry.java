package com.myshopping.network;
...
public class ProductEntry {
    ...
    public String is_added_cart = "0";

    public ProductEntry(
            String title, String dynamicUrl, String url, String price, String description, String is_added_cart) {
        this.title = title;
