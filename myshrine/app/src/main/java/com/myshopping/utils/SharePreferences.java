...
public class SharePreferences {
    ...
    public String getStringPref(String key) {
        SharedPreferences pref = appObj.getSharedPreferences(App.PREF_NAME,
  ...
  /*  public void saveArray(Context context, String[] array, String arrayName) {
    ...
    public void saveArray(Context context, String[] array, String arrayName) {
        SharedPreferences settings = context.getSharedPreferences(
                App.PREF_NAME, Context.MODE_PRIVATE);
   ...
   /* public int getArraySize(Context context, String arrayName) {
    ...
    public int getArraySize(Context context, String arrayName) {
        SharedPreferences settings = context.getSharedPreferences(App.PREF_NAME, Context.MODE_PRIVATE);
        return settings.getInt(arrayName + "_size", 0);
    }
